...
export default function successbalance() {
  ...
  return (
    <View style={styles.homeContainer}>
      <View style={[styles.successContent, status === 'paid' ? '' : { backgroundColor : '#da0002' }]}>
        <View style={{ flexDirection : 'row', justifyContent : 'center', alignItems : 'flex-end', gap : 15}}>
        <View style={styles.checkCircle}>
            ...
            <View>
                <Text style={styles.successTitle}>Balance : ₹{amount}</Text>
